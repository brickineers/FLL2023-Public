...
def Pick_Up_Skateboard_Expert():
    gyro_turn(38, RIGHT, RIGHT, 20)
    drive_distance_cm(32, FORWARD, 60, 60)
    arm_up(200, 20)

def Chicken_Printer():
    drive_distance_cm(14, FORWARD, 40, 40)
    MotorC_Run(1600, 100)
    drive_distance_cm(30, BACKWARD, 80, 80)

def Collet_VE_Director():
    gyro_turn(40, CENTER, LEFT, 20)
    drive_distance_cm(30, FORWARD, 50, 45)

def Tower():
    drive_distance_cm(12, FORWARD, 40, 52)
    drive_distance_cm(71 , FORWARD, 80, 83)
    gyro_turn(22, RIGHT, LEFT, 20)
    drive_distance_cm(21, BACKWARD, 80, 80)
    drive_distance_cm(10, BACKWARD, 30, 30)
    MotorC_Run(200, 100)
    drive_distance_cm(80, FORWARD, 100, 94)

def Art_Piece_Delivery():
    drive_distance_cm(2, BACKWARD, 40, 40)
    gyro_move(1.5, 80, FORWARD)
    drive_distance_cm(62, FORWARD, 60, 67)

def Immersive_Experience():
    drive_distance_cm(37, BACKWARD, 60, 75)
    gyro_turn(47, RIGHT, LEFT, 20)
    drive_distance_cm(15, FORWARD, 60, 60)
    drive_distance_cm(17, FORWARD, 40, 40)
    drive_distance_cm(20, BACKWARD, 60, 60)
    '''gyro_turn(75, RIGHT, RIGHT, 20)
    drive_distance_cm(80, FORWARD, 80, 80)
    gyro_turn(55, LEFT, RIGHT, 30) 
    drive_distance_cm(60, FORWARD, 80, 80)'''

def Spinning_Show__Pick_Up_Expert():
    drive_till_color('B', 60, 'black')
    drive_distance_cm(3, FORWARD, 40, 40)
    line_follow_till_color('B', LEFT, 40, 'black')
    drive_distance_cm(4, BACKWARD, 50, 50)
    drive_distance_cm(3, FORWARD, 0, 20)

def Deliver_Skateboard_Expert():
    gyro_turn(37, LEFT, RIGHT, 20)
    drive_distance_cm(19, FORWARD, 60, 60)
    drive_distance_cm(20, BACKWARD, 62, 60)
    drive_distance_cm(66, BACKWARD, 90, 88)

def Stage_Speakers_Lights():
    drive_distance_cm(20, BACKWARD, 60, 60)
    drive_distance_cm(24, FORWARD, 30, 60)
    drive_distance_cm(105, BACKWARD, 81, 80)



def Boat_Cam__Rolling_Cam_Lever():
    drive_distance_cm(54, FORWARD, 62, 60)
    arm_down(210, 30)
    drive_distance_cm(10, BACKWARD, 40, 40)
    gyro_turn(30, CENTER, LEFT, 20)
    arm_up(40, 5)
    arm_up(170, 50)
    drive_distance_cm(40, BACKWARD, 60, 90)

def Sound_Mixer():
    drive_distance_cm(2, BACKWARD, 30, 30)
    drive_distance_cm(53, FORWARD, 40, 40)
    drive_distance_cm(53, BACKWARD, 60, 65)

#Missions 
def Dragon_Delivery():
    db.gyroStraightDrive(41, 50, 100, 80)
    db.gyroStraightDrive(12, -50, -50, -50)
    db.gyroStraightDrive(15, 100, 100, 100)
    drive_distance_cm(3, FORWARD, 90, 20)
    drive_distance_cm(42, BACKWARD, 100, 100)

def Pick_Up_Skateboard_Expert_New():
    db.gyroRotation(-46, 70, 70, 70, rotate_mode=1, generator=driveMotor(0.56, 50, 'D'))
    db.gyroStraightDrive(23.5, 40, 70, 40)
    arm_up(160, 20)

def Chicken_Printer_New():
    drive_distance_cm(19, FORWARD, 50, 50)
    MotorC_Run(2000, 100)
    db.gyroStraightDrive(22, -50, -80, -50)

def Collet_VE_Director_New():
    db.gyroRotation(-37, 50, 50, 50, rotate_mode=0)
    arm_down(180, 20)
    db.gyroStraightDrive(12, 40, 40, 40)
    arm_up(160, 20)

def Tower_New():
    db.gyroRotation(10, 55, 55, 55)
    db.gyroStraightDrive(60, 50, 100, 50, stopMethod=SM.stopLine(db, 'B', 20, 30))
    db.gyroRotation(-8, 50, 50, 50)
    db.gyroStraightDrive(32, 50, 100, 60)
    db.gyroRotation(-30, 50, 50, 50)
    #db.gyroStraightDrive(5, -50, -70, -50)
    drive_distance_cm(17, BACKWARD, 40, 40)
    MotorC_Run(2100, 100)
    db.gyroStraightDrive(5, 60, 60, 60)
    drive_distance_cm(75, FORWARD, 100, 95)
    
def Art_Piece_Delivery_New():
    drive_distance_cm(2, FORWARD, 40, 40)
    db.gyroStraightDrive(2, -40, -50, -40)
    db.gyroRotation(60, 50, 50, 50)
    print(phub.motion_sensor.get_yaw_angle())
    db.gyroStraightDrive(55, -50, -90, -50)
    db.gyroRotation(-20, 55, 55, 55)
    print(phub.motion_sensor.get_yaw_angle())
    db.gyroStraightDrive(45, -50, -90, -50)
    db.gyroRotation(-36, 50, 50, 50)
    print(phub.motion_sensor.get_yaw_angle())
    db.gyroStraightDrive(8, -50, -50, -50)
    db.gyroStraightDrive(14, 50, 80, 80)
    drive_distance_cm(13, FORWARD, 80, 80)
    db.gyroStraightDrive(10, -50, -50, -50)
    #db.gyroStraightDrive(12, 50, 80, 80)
    drive_distance_cm(15, FORWARD, 80, 80)
    db.gyroStraightDrive(12, -50, -50, -50)
    MotorC_Run(175, 50)
    MotorC_Run(190, -30)
    #drive_distance_cm(17, FORWARD, 60, 60)
    #db.gyroStraightDrive(1, 50, 50, 50)
    db.gyroRotation(86, 50, 50, 50)
    db.gyroStraightDrive(3, -50, -50, -50,)
    db.gyroStraightDrive(10, -55, -55, -55, generator=driveMotor(0.56, -60, 'C'))
    db.gyroStraightDrive(15, -55, -55, -55, stopMethod=SM.stopResistance(db, 1250))
    db.gyroStraightDrive(6.5, 50, 50, 50)
    db.gyroRotation(35, 80, 80, 80)
    db.gyroStraightDrive(4, -50, -50, -50)
    db.arcRotation(6, -60, -50, -50, -50)
    db.gyroStraightDrive(5, -50, -50, -50)
    MotorC_Run(190, -50)
    db.gyroStraightDrive(13, -50, -50, -50)
    phub.motion_sensor.reset_yaw_angle()
    db.gyroRotation(-81, 50, 50, 50)
    db.gyroStraightDrive(85, 100, 100, 100)

    
def Immersive_Experience_New():
    #Adjust as needed
    db.gyroStraightDrive(21, -40, -90, -40)
...
def Spinning_Show__Pick_Up_Expert_New():
    db.gyroStraightDrive(15, -50, -60, -50)
    db.gyroStraightDrive(20, -50, -50, -50, stopMethod=SM.stopLine(db, 'A', 20, 5))
    db.gyroStraightDrive(2, 50, 50, 50)
    db.gyroRotation(-85, -40, -40, -40, rotate_mode=0)
    db.gyroStraightDrive(10, 50, 50, 50, stopMethod=SM.stopLine(db, 'A', 20, 0))
    db.gyroStraightDrive(1.5, 50, 50, 50)
    MotorC_Run(-200, 20)
    db.gyroStraightDrive(1, -50, -50, -50)
    db.gyroRotation(60, -40, -40, -40)
    db.gyroStraightDrive(75, -50, -100, -70)

def Deliver_Skateboard_Expert_New():
    db.gyroStraightDrive(50, 50, 100, 50)
    db.gyroRotation(40, 50, 50, 50)
    db.gyroStraightDrive(35, 50, 100, 50)

def Sound_Mixer_New():
    db.gyroStraightDrive(52, 50, 100, 50, brakeStart=0.6, generator=driveMotor(0.56, -60, 'C'))
    MotorC_Run(-230, 20)
    db.gyroStraightDrive(55, -100, -100, -100)
    MotorC_Run(200, 50)
    
def Rollling_Cam():
    drive_distance_cm(50, FORWARD, 60, 65)
    drive_distance_cm(52, BACKWARD, 100, 95)
...
def Augmented_Reality_Statue():
    ...
    db.gyroStraightDrive(7, -50, -50, -50)
...
def Deliver_Music_Expert():
    db.gyroStraightDrive(82, 90, 90, 90)
    drive_distance_cm(3, FORWARD, 40, 80)
    MotorC_Run(350, -100)
...
def run_8(vm, stack):
     phub.motion_sensor.reset_yaw_angle()
     wait_for_seconds(0.5)
     Deliver_Music_Expert()

def E(vm, stack):
    drive_distance_cm(14, FORWARD, 50, 50)
    
def T(vm, stack):
    db.gyroStraightDrive(10, -45, -45, -45, generator=driveMotor(0.56, 60, 'C'))
...
def B(vm, stack):
    rb = battery.voltage()/8300
    b_val = str(round_up(rb, 3) * 100) 
    print(b_val + '%')
    phub.light_matrix.write(b_val + '%')
...
run_funcs = [None, run_1, run_2, run_3, run_4, run_5, run_6, run_7, run_8, E, T, U, Warm_up]

run_names = [None, 1, 2, 3, 4, 5, 6, 7, 8, 'E', 'T', 'U', 'W']
